...
Key to amigazen project's approach is ensuring every project can be built with the same common set of development tools and configurations, so the ToolKit project was created to provide a standard configuration for Amiga development. All *amigazen project* releases will be guaranteed to build against the ToolKit standard so that anyone can download and begin contributing straightaway without having to tailor the toolchain for their own setup.
...
- **Amiga Python 2** - Irmen de Jong's Amiga Python 2 port updated to the final version, Python 2.7.18
...
- _OpenTriton_ - Stefan Zeiger's triton.library application framework
- _BGUI_ - The BGUI Boopsi GUI application framework
_ _APlusPlus_
_ _OUI_
_ _
